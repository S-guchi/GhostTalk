...
- [x] 13. ChatStageコンポーネントの実装
  - [x] 13.1 チャットステージコンポーネントを作成
    - `components/ChatStage.tsx`を作成
    - 3体のGhostCharacterを配置（位置を計算）
    - _Requirements: 3.1, 3.2, 3.3_
  
  - [x] 13.2 AI APIからのストリーミングレスポンス処理を実装
